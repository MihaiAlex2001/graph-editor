function init() {
    ...
    var roundedRectangleParams = {
      parameter1: 3,  // cornere rotunjite
      ...
      $(go.Diagram, "BoxDiv",
        {
          ...
          "clickCreatingTool.archetypeNodeData": { text: "nod" },     // adaugare data pt nod
    ...
    Box.nodeTemplate =
      ...
      $(go.Node, "Auto",
        ...
        $(go.TextBlock,
          {
            font: "bold small-caps 12pt helvetica, bold arial, sans-serif", margin: 7, stroke: "rgba(0, 0, 0, .87)",//intunicat nod
            editable: true
          },
          ...
          $(go.Shape,
            {
              fill: $(go.Brush, "Radial",
                { 0.7: "white", 0.9: "yellow", 1: "rgba(255, 255, 255, 0)" }), //fundal text muchie
              stroke: null
            }),
          $(go.TextBlock, "muchie",  // text muchie
            {
              textAlign: "center",
